  ...
  const items = [
    {
      ...
      cardTitle: "Contributor",
      url: "https://susmitadey.hashnode.dev/my-3-months-open-source-journey-at-gssoc22",
      cardSubtitle: "Contributor at GirlScript Summer of Code 2022",
      cardDetailedText:
        "GirlScript Summer of Code is a 3-month long Open Source program by GirlScript Foundation. I was selected as a contributor and it helped me to get started with Open Source and I learned a lot of new things throughtout this 3 months of journey. At the end of this program, I ranked 95 ⭐ among the 100 top contributors.",
      media: {
        type: "IMAGE",
        source: {
    ...
    },
    {
      ...
      media: {
        type: "IMAGE",
        source: {
          url: "https://media.istockphoto.com/photos/ambassador-on-wooden-blocks-cross-processed-image-with-wooden-table-picture-id1279586028",
        },
      },
    },
    {
